        ...
        <div class="footer-content background-footer-03">
            <div class="container">
                <div class="row">
                    <div class="col-lg-4 col-md-4 col-sm-9">
                        <section class="footer-item">
                            ...
                            <div class="footer-phone-info">
                                ...
                                <p class="r-info">
                                    <span>Có câu hỏi cho chúng tôi ?</span>
                                    <span>(700)  9001-1909  (900) 689 -66</span>
                                </p>
                            </div>
                            <div class="newsletter-block layout-01">
                                <h4 class="title">Đăng ký nhận quảng cáo</h4>
                        ...
                        <section class="footer-item">
                            ...
                            <div class="row">
                                ...
                                <div class="col-lg-6 col-sm-6 col-xs-6">
                                    <div class="wrap-custom-menu vertical-menu-2">
                                        <ul class="menu">
                                            <li><a href="#">Chúng toi là ai</a></li>
                                            <li><a href="#">Dịch vụ của chúng tôi</a></li>
                                            <li><a href="#">Dự án sắp tới</a></li>
                    ...
                    <div class="col-lg-4 col-md-4 col-sm-6 md-margin-top-5px sm-margin-top-50px xs-margin-top-40px">
                        <section class="footer-item">
                            <h3 class="section-title">Văn phòng quản lý</h3>
                            <div class="contact-info-block footer-layout xs-padding-top-10px">
                                <ul class="contact-lines">
                                    <li>
                                        <p class="info-item">
                                            <i class="biolife-icon icon-location"></i>
                                            <b class="desc">Đại học Cần Thơ, Hưng Lợi, Ninh Kiều, Cần Thơ </b>
                                        </p>
                                    </li>
                                    <li>
                                        <p class="info-item">
                                    ...
                                    <li>
                                        <p class="info-item">
                                            ...
                                            <b class="desc">Email:  atadi@company.com</b>
                                        </p>
                                    </li>
                                    <li>
                                        <p class="info-item">
