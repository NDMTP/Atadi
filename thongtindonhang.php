                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
                            ...
                            <div class="signin-container">
                                ...
                                Khách hàng: <span
                                    style="font-size: 17px; font-weight: bold;"><?php echo $_GET['hoten'] ?></span><br>
                                SDT: <span
                                    style="font-size: 17px; font-weight: bold;"><?php echo $_GET['sdt'] ?></span><br>
                                Địa chỉ: <span
                                    style="font-size: 17px; font-weight: bold;"><?php echo $row['TENKHUVUC'].', Quận '.$_GET['quan']?></span><br>
                                Ghi chú: <span
                                    style="font-size: 17px; font-weight: bold;"><?php echo $_GET['note']?></span><br>
                                Ngày mua: <span
                                    style="font-size: 17px; font-weight: bold;"><?php echo date('d-m-Y') ?></span><br>
                                <?php
