                    ...
                    <div class="card-header d-flex align-items-center justify-content-between pb-0">
                        <div class="row">
                            <div class="card-title text-nowrap col-6">
                                ...
                                <h2 class="mb-2"><?php echo $rowloai['tongloai']; ?></h2>
                            </div>
                            <div class="card-title  col-6">
                                <h5 class="me-3 text-nowrap">Sản phẩm </h5>
                                <h2 class="mb-2"><?php echo $rowsp['tongsp']; ?></h2>
                        ...
                        <ul class="p-0 m-0">
                            ...
                            <li class="d-flex mb-4 pb-1">
                                ...
                                <div class="d-flex w-100 flex-wrap align-items-center justify-content-between gap-2">
                                    <div class="me-2 m-2">
                                        <h6 class="mb-0"> <?php echo $row_loai['TENLOAI']; ?></h6>

                                    </div>
                                    <div class="user-progress">
                                        <small class="fw-semibold"><?php echo $row_loai['tongsp']; ?></small>
                                    </div>
                                </div>
                                <?php }?>
                            </li>
            ...
            <div class="col-12 col-sm-12 col-lg-4">
                ...
                ?>
                                    ...
                                    overflow: hidden;text-overflow: ellipsis;"
                                                    ...
                                                    <?php echo $row_topsp['TENSP']; ?></h6>
                                                <h6 class="mb-0">
                                                    <?php echo $row_topsp['MASP']; ?></h6>
                                            </div>
                                            <div class="user-progress">
                                                <small class="fw-semibold"><?php echo $row_topsp['tongban']; ?></small>
                                            </div>
                                        </div>
