                                        ...
                                        <div class="info">
                                            ...
                                            <div class="slide-down-box">
                                                <div class="buttons">
                                                    ...
                                                    <a href="themvaogiohang.php?sb_cate=&pdid=<?php echo $row['MASP'] ?>&size=<?php echo $row['MASIZE'] ?>&qty12554=1" style="padding: 10px 5px !important; " class="btn add-to-cart-btn">thêm vào giỏ</a>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
